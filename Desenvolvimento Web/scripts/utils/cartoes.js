...
function cartao() {
    ...
    if (Number(numeracao) == 1) {
        numeracao ++
        cartao.style.backgroundImage = 'url("assets/midias/cartao_interlagos.png")'
        direito.innerHTML = `<p>CARTÃO <br>INTERLAGOS</p>`
    } else if (Number(numeracao) == 2) {
        numeracao ++
        cartao.style.backgroundImage = 'url("assets/midias/cartao_monaco.png")'
        direito.innerHTML = `<p>CARTÃO <br>MÔNACO</p>`
    } else if (Number(numeracao) == 3) {
        numeracao = 1
        cartao.style.backgroundImage = 'url("assets/midias/cartao_classic.png")'
